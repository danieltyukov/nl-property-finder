...
test('backslashes and line breaks in a title are escaped once', () => {
  const p: Property = { id: 'p1', key: 'k', title: 'Kamer A\\B\nboven', address: { city: 'Delft' }, createdAt: 't', updatedAt: 't' };
  const v: Viewing = { id: 'v1', applicationId: 'a1', propertyId: 'p1', startsAt: '2026-09-24T16:30:00.000Z', endsAt: '2026-09-24T16:45:00.000Z', state: 'booked', bookedBy: 'agent' };
  const ics = renderIcs([v], new Map([['p1', p]]), '2026-09-24T10:00:00.000Z');
  expect(ics).toContain('SUMMARY:Viewing: Kamer A\\\\B\\nboven');
});
