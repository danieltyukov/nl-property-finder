...
export const DOCUMENT_KINDS: Record<string, string[]> = {
  id: ['identiteitsbewijs', 'paspoort', 'passport', 'idkaart', 'idcard', 'identitycard', 'identiteitskaart', 'rijbewijs', 'drivinglicence', 'driverslicense', 'legitimatie', 'kopieid', 'copyofid', 'identity'],
  payslip: ['loonstrook', 'loonstroken', 'salarisstrook', 'salarisstroken', 'payslip', 'salaryslip', 'paystub', 'inkomensverklaring', 'jaaropgave', 'ib60', 'proofofincome', 'inkomen', 'income'],
  employer_statement: ['werkgeversverklaring', 'employerstatement', 'employersdeclaration', 'arbeidscontract', 'arbeidsovereenkomst', 'employmentcontract', 'contractofemployment'],
  enrolment: ['inschrijfbewijs', 'bewijsvaninschrijving', 'inschrijvingsbewijs', 'collegekaart', 'studentenkaart', 'studentcard', 'enrolment', 'enrollment', 'proofofenrolment', 'studiebewijs'],
  bank_statement: ['bankafschrift', 'bankafschriften', 'rekeningafschrift', 'bankstatement', 'saldo'],
  landlord_reference: ['verhuurdersverklaring', 'huurdersverklaring', 'landlordreference', 'referentie', 'reference'],
  guarantor: ['garantstelling', 'borgstelling', 'borgsteller', 'guarantor', 'guarantee'],
  tenant_profile: ['huurdersprofiel', 'profiel', 'profile', 'motivatie', 'motivation', 'introductie', 'introduction', 'cv'],
};

const GENERIC = ['documenten', 'documents', 'stukken', 'papieren', 'papers', 'gegevens', 'dossier', 'huurdossier'];
