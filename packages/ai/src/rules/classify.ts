...
const DOCUMENTS: [RegExp, DocumentKind, number][] = [
  ...
  [/\b(?:kopie|copy)\b[^.?!\n]{0,25}\b(?:id|identiteitsbewijs|legitimatie|id-?kaart)\b/, 'id', 3],
  [/\b(?:identiteitsbewijs|id-?kaart|id card|legitimatiebewijs)\b/, 'id', 2],
  [/\b(?:kopie|copy)\b[^.?!\n]{0,25}\b(?:paspoort|passport)\b/, 'passport', 3],
  [/\b(?:paspoort|passport)\b/, 'passport', 2],
